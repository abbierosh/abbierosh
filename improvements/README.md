...
If the same issue is painful to diagnose every time, that usually means the system needs better visibility, better tooling, or a cleaner workflow around it.

This folder captures that second layer of thinking:
